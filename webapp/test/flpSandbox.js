		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsolviaproject4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsolviaproject4-display": {
								"semanticObject": "comsolviaproject4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.solvia.project4",
									"url": sap.ui.require.toUrl("com/solvia/project4")
								}
							}
						}
					}
